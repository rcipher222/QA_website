...
alert(txt.textContent[1]);

if(txt.textContent[1]=="F"){
...
//echo strcmp(substr($row[6],0,1),"'");
if(strcmp(substr($row[6],0,1),"'")==0)
$row[6]=substr($row[6],1,strlen($row[6])-2);
//echo $row[6];
...
<div class="col-md-5">
<h3><?php  echo ucwords($_GET['username']); ?></h3>
<button class="btn btn-info btn-md" id="btn" onclick="changeText()">
<?php 
include 'dbconnection.php';
$username=$_GET['username'];
