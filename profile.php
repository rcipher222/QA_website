...
//echo '<img src="images/default_profile.jpg" width="130px" height="130px" id="disp_p_image">';

?>

</div>
<form id="uploadImage" action="upload_profile_image.php" method="POST" enctype="multipart/form-data" onsubmit="fun()">
...
<script type="text/javascript">function fun(){var ch=document.getElementById("upload").value;alert(ch);}</script>
<hr>
<p id="ppos">asd</p>
<p>asd</p>
<p>asd</p>
...
<div class="col-md-5">
<h3><?php  echo ucwords($_SESSION['fname']); /*echo $_SESSION['uid'];*/ ?></h3>
<hr>
